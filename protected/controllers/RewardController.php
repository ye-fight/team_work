...
class RewardController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$_POST['Reward']['user_id'] = Yii::app()->user->getId();
			$_POST['Reward']['flag'] = 0;
			$tmp = explode('-', $_POST["Reward"]['create_time']);
			$_POST['Reward']['create_time'] = time();
			$tmp = explode('-', $_POST["Reward"]['end_time']);
			$_POST['Reward']['end_time'] = mktime(0, 0, 0, $tmp[1], $tmp[2], $tmp[0]);			
	...
	public function actionUpdate($id)
	{
		...
		if($model['flag'])
			throw new CHttpException(404,'悬赏已完成，无法更改');
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);
	...
	{
		$dataProvider= Reward::model()->findAll(array(
	...
	public function actionAdmin()
	{
		...
		$model=new CActiveDataProvider('Reward',
